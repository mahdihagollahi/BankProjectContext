         ...
         ml-[64px] block w-9/12 p-2.5  dark:border-gray-200
          ...
          <div className="flex mt-10 text-right text-black">
            <div className="">
              ...
              <p className="text-xs opacity-50dark:border-gray-200">
          ...
          <div className="flex mt-10 text-black">
            <div>
              <h2 className="text-bold text-lg mr-[80px]">Transfer amount</h2>
              <p className="text-xs mr-4 opacity-50">Please enter u're Transfer amount</p>
            </div>
            <div className="flex gap-2 ml-[187px]">
              <input
                style={{ color: "black" }}
                ...
                value={cartCash}
                onChange={(e)=>setcartCash(e.target.value)}
